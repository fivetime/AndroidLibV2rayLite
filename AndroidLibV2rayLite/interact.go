...
import (
	...
	v2filesystem "github.com/v2fly/core/common/platform/filesystem"
	v2stats "github.com/v2fly/core/features/stats"
	v2serial "github.com/v2fly/core/infra/conf/serial"
	_ "github.com/v2fly/core/main/distro/all"
	v2internet "github.com/v2fly/core/transport/internet"

	v2applog "github.com/v2fly/core/app/log"
